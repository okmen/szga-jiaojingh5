...
export const createDriveInfoZJ13 = `http://192.168.1.247:8080/web/bookingbusiness/createDriveInfo_ZJ13.html`  // 香港机动车驾驶证免试换证

export const createDriveInfoZJ16 = `http://192.168.1.247:8080/web/bookingbusiness/createDriveinfo_ZJ16.html`  // 临时机动车驾驶许可申领

export const createDriveInfoZJ17 = `http://192.168.1.247:8080/web/bookingbusiness/createDriveInfo_ZJ17.html`  // 持境外驾驶证申请换证

export const createDriveInfoZJ20 = `http://192.168.1.247:8080/web/bookingbusiness/createDriveInfo_ZJ20.html`  // 其他业务(驾驶证)

export const createDriveInfoZJ21 = `http://192.168.1.247:8080/web/bookingbusiness/createDriveInfo_ZJ21.html`  // 恢复驾驶资格（逾期一年以上未换证类)

export const createDriveInfoZJ22 = `http://192.168.1.247:8080/web/bookingbusiness/createDriveInfo_ZJ22.html`  // 恢复驾驶资格（逾期一年以上未体检类)
