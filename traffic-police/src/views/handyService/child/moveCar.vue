    ...
    <ul class="moveCar-list">
      ...
      <li class="moveCar-item">
        ...
        <div class="div-select">
          <span class="btn-select" @click.stop="carTypeSelectClick()">{{carTypeSelectMassage}}</span>
      ...
      <li class="moveCar-item">
        ...
        <div class="moveCar-item-text">
          <input class="text-input" type="text" name="" value="" placeholder="请输入车架号后四位">
        </div>
      </li>
      <button class="btn" type="button" name="button">发送短信</button>
    </ul>
  ...
  export default{
    ...
    methods: {
      ...
      carTypeSelectClick: function (str) {
        if (str) {
          this.carTypeSelectMassage = str
        }
        this.abbreviationSelectShow = false
        if (this.carTypeSelectShow === true) {
          this.carTypeSelectShow = false
        } else {
