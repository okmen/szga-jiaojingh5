  ...
  <div class="register">
    ...
    <div class="register-item">
      ...
      <div class="register-item-input send-code">
        <input type="text" placeholder="请输入验证码" class="send-code-input" maxlength="6" v-model="verificationCode">
    ...
    <div-select :childInfo="vehicleModels" @getSelected="getVehicleModelsOne"></div-select>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getVehicleModelsOne (val) {
        this.vehicleModelsOne = val
      },
      ...
      registerSubmit () {
        ...
        let requestObj = {
          ...
          IDcard: this.IDcard, // 证件号码
          mobilePhone: this.mobilePhone, // 手机号码
          verificationCode: this.verificationCode,  // 验证码
          plateNum: this.provinceCodeOne + this.plateNum.toUpperCase(), // 车牌号码
          vehicleNum: this.vehicleNum, // 车架后四位
          useNatureOne: this.useNatureOne, // 使用性质
          carSelectDataOne: this.carSelectDataOne, // 车辆类型
          appointmentLocationOne: this.appointmentLocationOne, // 预约地点
          vehicleModelsOne: this.vehicleModelsOne // 车辆型号
        }
