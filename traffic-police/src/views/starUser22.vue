  ...
  <div class="starUser-outer">
    <div class="starUser-select pad-side-50">
      ...
      <div class="div-select">
        <span id="btnSelect" class="btn-select" @click.stop="typeSelectClick()">{{ starUserData.init }}</span>
        <div class="div-select-ul" v-if='typeSelectShow'>
          <ul>
            <li v-for="item in starUserData.type" @click.stop = "typeSelectClick(item.name)">{{item.name}}</li>
          </ul>
        </div>
      </div>
    </div>
    <div class="starUser-from pad-side-50">
      <!-- <div id="starUser-hbs">
        <ul class="starUser-hbs-list">
          <li class="starUser-hbs-item" v-for="hbsItem in starUserData.type">
